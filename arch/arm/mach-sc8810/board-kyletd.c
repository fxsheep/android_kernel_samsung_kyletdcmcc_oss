...
static struct stc311x_platform_data stc3115_data = {
		...
		.CapDerating[2] = -8,  /* capacity derating in 0.1%, for temp = 25°C */
		.CapDerating[1] = -12,  /* capacity derating in 0.1%, for temp = 40°C */
		.CapDerating[0] = -20,  /* capacity derating in 0.1%, for temp = 60°C */
